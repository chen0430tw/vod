"""Unconditional sample fidelity v4 — detached latent training.
...
Four fixes vs v1:
  ...
  Fix D (NEW in v4) — detach latent before diffusion loss
...
All four fixes live in this trainer script — no changes to vod_minimal/.
"""
...
def main():
    ...
    p.add_argument("--out", default="generated/diffusion_samples_v4")
    p.add_argument("--report-out", default="prototype/unconditional_fidelity_result_v4.json")
    p.add_argument("--md-out", default="prototype/unconditional_fidelity_report_v4.md")
    args = p.parse_args()
