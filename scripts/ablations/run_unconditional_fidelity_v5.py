"""Unconditional sample fidelity v5 — epsilon prediction + tunable lr.
...
Five fixes vs v1:
  ...
  Fix E (NEW in v5) — epsilon prediction + smaller lr default
...
All five fixes live in this trainer script — no changes to vod_minimal/.
"""
...
def main():
    ...
    p.add_argument("--out", default="generated/diffusion_samples_v5")
    p.add_argument("--report-out", default="prototype/unconditional_fidelity_result_v5.json")
    p.add_argument("--md-out", default="prototype/unconditional_fidelity_report_v5.md")
